...
## Project Structure
    ...
    ├── testapiautoconnecto_66016  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_66016`
...
2. Clone this repo and `cd testapiautoconnecto_66016`
